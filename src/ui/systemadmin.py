...
class Ui_System(object):
    ...
    def retranslateUi(self, System):
        ...
        self.label_info.setText(_translate("System", "Logeado como ..."))
        self.btn_logout.setText(_translate("System", "Cerrar Sesión"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("System", "Tab 1"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("System", "Tab 2"))
